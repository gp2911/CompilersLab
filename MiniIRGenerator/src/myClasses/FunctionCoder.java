...
import java.util.*;
//TODO: Something wrong happening in fac_computeFac
/**
 * Provides default methods which visit each node in the tree in depth-first
 * order.  Your visitors may extend this class.
 */
public class FunctionCoder<R> implements GJNoArguVisitor<R> {
    //
...
//        System.out.
//                println("||||||||||||||||||||||||||||");
//        Hashtable < String, ClassDetails > symbolTabBkup = new Hashtable<String, ClassDetails>() ;
//        symbolTabBkup.putAll(symbolTable);
//        System.out.println(symbolTabBkup);
////
...
//                String fname = j.next();
//                FuncDetails myFunc = myClass.classFuncs.get(fname);
//                //System.out.println("YOLO: "+myClass.name+"."+myFunc.name+" : "+myFunc.localVars);
//                if(myFunc.localVars != null)
//                newlocals.put(myFunc,myFunc.localVars);
//
//            }
//        }
...
//        //System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>maami<<<<<<<<<<<<<<<<<<<<");
        ...
        // Loop to print out all functions I have used
...
//            j = symbolTable.get(myClass).classFuncs.keySet().iterator();
//            //System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>bonda<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<");
//            while (j.hasNext()){
//                String fname = j.next();
//                FuncDetails myFunc =symbolTable.get(myClass).classFuncs.get(fname);
//                //System.out.println(symbolTable.get(myClass).name+"."+myFunc.name+" : "+myFunc.localVars);
//                myFunc.localVars = newlocals.get(myFunc);
//                //System.out.println("NEW :"+symbolTable.get(myClass).name+"."+myFunc.name+" : "+myFunc.localVars);
//            }
//            //System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>bulby<<<<<<<<<<<<<<<<<<<<<<<<<<<<");

            if(symbolTable.get(myClass) != null && symbolTable.get(myClass).classFuncCodes != null){
//                //System.out.println("{{{{{{{{{{{{}}}}}}}}}}}}");
//                //System.out.println(symbolTable.get(myClass).name+" : "+ symbolTable.get(myClass).initHash);

//                symbolTable.get(myClass).classVars.clear();
                symbolTable.get(myClass).classVars = symbolTable.get(myClass).initHash;
                Iterator<FuncCode> func = symbolTable.get(myClass).classFuncCodes.iterator();
                while(func.hasNext()){
//                    //System.out.println("{{{{{{{{{{{{}}}}}}}}}}}}");
//                    //System.out.println(symbolTable.get(myClass).name+" : "+ symbolTable.get(myClass).initHash);
                    FuncCode myFunc = func.next();
                    secondaryCoder.addCodeLine(myFunc.funcCode);
                }
            }
        }
...
//        //System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>tommy<<<<<<<<<<<<<<<<<<<<");
        ...
        // Get funcCodes of all non-overridden functions of derived classes
...
//                        myClass.classFuncCodes.add(myFuncCode);
...
//        //System.out.println("######################ˆˆˆˆˆˆˆˆinFuncCoderˆˆˆˆˆˆˆˆˆ*****************");
...
//        //System.out.println();
        ...
        while (stringIterator.hasNext()){
            ...
            subCoder.addCodeLine("HSTORE TEMP "+ tempIndex + " " + Integer.toString(4*i) + " " + tempVarMapping.get(tmp)+"  //     "+tmp);
            i++;
        }
        //return object
...
//        currClass.classFuncCodes = currFuncCodes;
    ...
    public R visit(ClassExtendsDeclaration n) {
        ...
        prevCoder = currCoder;
//        //System.out.println(currClass.name);
//        //System.out.println("######################ˆˆˆˆˆˆˆˆinFuncCodrˆˆˆˆˆˆˆˆˆ*****************");
//        //System.out.println(currClass.name);
//        //System.out.println(currClass.classVars);
//        //System.out.println(currVarTable);
        ...
        while (stringIterator.hasNext()){
            String tmp = stringIterator.next();
            subCoder.addCodeLine("HSTORE TEMP "+ tempIndex + " "+Integer.toString(4*i) +" "+ tmp);
            i++;
        }
        //return object
        subCoder.addCodeLine("RETURN TEMP "+ tempIndex);
...
//            //System.out.println("in here..."+myVar);
            if(currClass.initHash == null){
                currClass.initHash = new LinkedHashMap<String, VarDetails>();
            }
            currClass.initHash.put(myVar.name, myVar);
        }
        else{
...
//        //System.out.println(gen.code);
        ...
        inFunc = true;
        currCoder = myCoder;
//        currMethodCode = currMethodCode + currClass.name + "_" + myFunc.name ;
...
//            //System.out.println("Class Alloc stmt");
            myCoder.addCodeLine("HSTORE TEMP "+tempIndex+" 0 TEMP "+expr.retVal);
...
//        //System.out.println(expr.code);
        ...
        if(expr!=null && expr.code!="" && !Character.isDigit(expr.code.charAt(0))){
            ...
            if(heapStore.contains(expr.retVal)){
                myCoder.addCodeLine("HSTORE "+tmp+" 0 "+expr.retVal);
            }
            else{
...
//        //System.out.println("hello, "+expr);
        ...
        myGen.addCodeLine("CJUMP LT 0 TEMP "+expr.retVal+" L"+myIf.ifFalseLabel);
...
//        //System.out.println("pe2 : "+n.f2.f0.which);
    ...
    public R visit(ArrayLookup n) {
        ...
        myCoder.addCodeLine("HLOAD TEMP "+tempIndex+" "+array_index+" "+pe2.retVal );
        n.f3.accept(this);
...
//            //System.out.println(tempVarMapping.get(varName));
            ...
            if(heapStore.contains(i)){
                ...
                Stmt myId = new Stmt();
                myId.code = "MOVE TEMP "+tempIndex+" "+i;
                myId.retVal = tempIndex;
                myId.info = varName;
                tempIndex++;
                return (R) myId;
...
//            //System.out.println(varName);
    ...
    public R visit(ThisExpression n) {
        ...
        CodeGenerator thisCode = new CodeGenerator(indent);
